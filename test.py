...
echo("=== LISTS ===")
block_nums=[1,2,3]
echo("nums: "+toStr(block_nums))
listAppend(block_nums,10)
echo("after append: "+toStr(block_nums))
block_p=listPop(block_nums)
echo("popped: "+toStr(block_p))
echo("after pop: "+toStr(block_nums))
listExtend(block_nums,[5,6,7])
echo("after extend: "+toStr(block_nums))
echo("=== MAPS ===")
block_user=[
    "name":block_name,
    "age":block_age,
...
echo("user: "+toStr(block_user))
mapSet(block_user,"age",20)
echo("updated user age: "+toStr(mapGet(block_user,"age",NONE)))
echo("keys: "+toStr(mapKeys(block_user)))
echo("values: "+toStr(mapValues(block_user)))
echo("=== NUMBERS ===")
...
echo("=== FILE I/O ===")
block_file=fOpen("block_demo.txt","w")
fWrite(block_file,"Hello from BLOCK!\n")
fWrite(block_file,"This file was written using builtins.\n")
fClose(block_file)
file2=fOpen("block_demo.txt","r")
block_content=fRead(file2)
fClose(file2)
echo("file content:")
echo(block_content)
echo("Done.")
